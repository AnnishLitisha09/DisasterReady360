  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        >
          <Text style={[styles.verifyText, otpVerified && { color: 'green' }]}>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: moderateScale(24), fontStyle: 'italic', color: '#E35B33', textAlign: 'center', marginTop: moderateScale(46), fontWeight: 'bold' },
  subtitle: { fontSize: moderateScale(20), fontWeight: 'bold', color: '#000', textAlign: 'center', marginTop: moderateScale(30) },
  description: { fontSize: moderateScale(12), color: '#333', textAlign: 'center', marginTop: moderateScale(13), marginBottom: moderateScale(50) },
  label: { fontSize: moderateScale(14), color: '#000', marginBottom: moderateScale(8), fontWeight: '600' },
  inputContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F5F7FA', borderRadius: moderateScale(10), paddingHorizontal: moderateScale(15), height: moderateScale(50) },
  input: { flex: 1, fontSize: moderateScale(14), color: '#000' },
  verifyText: { color: '#E35B33', fontWeight: '600' },
  rememberMeContainer: { flexDirection: 'row', alignItems: 'center', marginTop: moderateScale(15) },
  rememberMeText: { marginLeft: 8, fontSize: moderateScale(14), color: '#000' },
  loginButton: { borderRadius: moderateScale(30), justifyContent: 'center', alignItems: 'center', height: moderateScale(50), marginTop: moderateScale(30) },
  loginText: { color: '#FFFFFF', fontSize: moderateScale(16), fontWeight: '600' },
  footerText: { marginTop: moderateScale(20), textAlign: 'center', fontSize: moderateScale(14), color: '#000' },
