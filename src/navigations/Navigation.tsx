...
import { Dashboard, Getstarted, Infographics, Learningmodules, Loginpage, Otppage, Signup, Test, Veiwvideo } from '../screens';
// Screens
...
export const Navigation = () => {
  return (
    <NavigationContainer>
      <RootStack.Navigator initialRouteName="Learningmodules">
